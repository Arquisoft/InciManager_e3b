...
public class RespuestaAddIncidenceREST {
    ...
    public RespuestaAddIncidenceREST(String username, String password, String incidenceName, String description, String location, List<String> labels, HashMap<String, String> campos, Estado status, Date expiration, boolean cacheable) {
