...
public class IncidenceService {
	...
	/**
	 * Recibe de formulario un String con la forma campoA : valordelcampoA ; campoB:
	 * valordelcampoB ;campoC : valordelcampoC ; Luego, lo separa por ";" Y lo mete
	 * en un mapa después de separar por ":"
	 * 
	 * @param fields
	 *            String de campos
